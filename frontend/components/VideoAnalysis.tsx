    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-lightgray py-12 px-4">
      <div className="relative w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-10 flex flex-col items-center border border-bordergray">
        ...
        <div className="w-full flex flex-col items-center mb-8">
          <label htmlFor="video-upload" className="w-full flex flex-col items-center justify-center border-2 border-dashed border-primary rounded-xl py-8 cursor-pointer hover:border-accent transition">
            <span className="text-lg text-primary font-semibold mb-2 font-rubik">Choose Video File +</span>
